...
class tomcat::extras {
  ...
  Exec {
    path    => '/usr/bin',
    cwd     => "${::tomcat::catalina_home}/lib/extras",
    timeout => 0,
  ...
  exec {
    'get catalina-jmx-remote.jar':
      creates => "${::tomcat::catalina_home}/lib/extras/catalina-jmx-remote-${::tomcat::version}.jar",
    ...
    'get catalina-ws.jar':
      creates => "${::tomcat::catalina_home}/lib/extras/catalina-ws-${::tomcat::version}.jar",
    ...
    'get tomcat-juli-adapters.jar':
      creates => "${::tomcat::catalina_home}/lib/extras/tomcat-juli-adapters-${::tomcat::version}.jar",
    ...
    'get tomcat-juli-extras.jar':
      creates => "${::tomcat::catalina_home}/lib/extras/tomcat-juli-extras-${::tomcat::version}.jar",
  ...
  file {
    'extras directory':
      ...
      path    => "${::tomcat::catalina_home}/lib/extras",
      seltype => 'usr_t';

    'tomcat-juli.jar':
      ensure => link,
      path   => "${::tomcat::catalina_home}/bin/tomcat-juli.jar",
      target => "${::tomcat::catalina_home}/lib/tomcat-juli-extras.jar",
      backup => true;

    'catalina-jmx-remote.jar':
      ensure  => link,
      path    => "${::tomcat::catalina_home}/lib/catalina-jmx-remote.jar",
      target  => "extras/catalina-jmx-remote-${::tomcat::version}.jar",
      seltype => 'usr_t';

    'catalina-ws.jar':
      ensure  => link,
      path    => "${::tomcat::catalina_home}/lib/catalina-ws.jar",
      target  => "extras/catalina-ws-${::tomcat::version}.jar",
      seltype => 'usr_t';

    'tomcat-juli-adapters.jar':
      ensure  => link,
      path    => "${::tomcat::catalina_home}/lib/tomcat-juli-adapters.jar",
      target  => "extras/tomcat-juli-adapters-${::tomcat::version}.jar",
      seltype => 'usr_t';

    'tomcat-juli-extras.jar':
      ensure  => link,
      path    => "${::tomcat::catalina_home}/lib/tomcat-juli-extras.jar",
